...
#    setwd("C:/Hawaii_project/Hawaii/pub_code_data")    # Update here your directory
...
write.csv(datt_env, file = "C:/Hawaii_project/Hawaii/pub=code=data/data/datt_env_20240604.csv")
